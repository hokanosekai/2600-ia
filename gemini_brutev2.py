...
print("Chargement de Oversampling_1500.parquet...")
try:
    df = pd.read_parquet("Custom_Balanced.parquet")
except FileNotFoundError:
    print("Erreur: Le fichier 'Oversampling_1500.parquet' n'a pas été trouvé.")
    exit()
...
with open("student_model_gv2.skio", "wb") as f:
